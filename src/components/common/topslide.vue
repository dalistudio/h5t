<template>
	<div class="banner">
		...
		<div class="slide" transition="fadeIn" v-show="index === curpage" v-for="(item,index) in banners" :key="item.id">
			<a :href="item.sourceUrl" target="_blank"><img :src="item.imgUrl" alt="" /></a>
		</div>
	</div>
</template>
